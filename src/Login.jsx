    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background selection:bg-primary/30">
      <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-bottom-12 duration-1000 ease-[var(--spring-bounce)]">
        ...
        <div className="flex justify-center mb-6">
          <Link
            to="/"
            className="flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-foreground/50 hover:text-primary hover:translate-x-[-4px] transition-all duration-300 group"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-[-2px] transition-transform"><path d="M19 12H5M12 5l-7 7 7 7" /></svg>
            Back to home
          </Link>
        </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-muted-foreground/40 hover:text-primary bg-transparent hover:bg-transparent border-0 hover:border-0 outline-none focus:outline-none z-10 btn-no-glow hover:!shadow-none hover:!-translate-y-1/2 transition-all duration-300"
                  >
                    {showPassword ? (
