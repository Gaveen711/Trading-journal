...
export function ConsentModal({ onAgree }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] overflow-y-auto flex items-start sm:items-center justify-center p-4">
      {/* Backdrop */}
      <div className="fixed inset-0 bg-background/40 backdrop-blur-xl animate-in fade-in duration-700" />

      {/* Modal content */}
      <div className="relative w-full max-w-lg my-8 card-premium p-8 sm:p-12 space-y-8 animate-in zoom-in-95 slide-in-from-bottom-8 duration-700 flex flex-col items-center text-center shadow-[0_0_100px_rgba(139,92,246,0.1)] z-10">
        ...
        <div className="w-full space-y-4 pt-4">
          <div className="p-4 rounded-2xl bg-muted/30 border border-border/50 text-[10px] space-y-3 text-left leading-relaxed">
            <p className="font-bold text-foreground/80 uppercase tracking-widest text-[9px]">The Agreement:</p>
