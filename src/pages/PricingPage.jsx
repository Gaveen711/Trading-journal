        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
          ...
          >
            ...
            <div className="flex justify-between items-start mb-8 relative z-10">
              <div>
                <p className="text-xs font-bold tracking-[0.14em] uppercase text-primary mb-4">Pro</p>
                <div className="flex items-baseline gap-1">
                  <span className="text-5xl font-black tracking-tight leading-none text-transparent bg-clip-text bg-gradient-to-br from-primary to-primary-to">$19</span>
                  <span className="text-sm font-medium text-muted-foreground">/month</span>
                </div>
                <p className="text-xs text-muted-foreground mt-2 font-medium">or $190/year <span className="text-primary font-bold">— save 17%</span></p>
