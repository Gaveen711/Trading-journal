...
.xau-compare{grid-template-columns:repeat(3,minmax(0,1fr))}.xau-platforms,.xau-faq{grid-template-columns:repeat(2,minmax(0,1fr))}.xau-card{min-height:100%;padding:20px}.xau-card h3{margin-top:16px;color:var(--xau-ink);font-size:17px!important;font-weight:880!important;line-height:1.2!important;letter-spacing:0!important}.xau-card p{margin-top:10px;color:var(--xau-muted);font-size:14px;line-height:1.65;font-weight:540}.xau-compare-label{color:var(--xau-warm);font-size:12px;font-weight:860;line-height:1.4;text-transform:uppercase}.xau-highlight{border-color:color-mix(in srgb,var(--xau-warm) 48%,var(--xau-border));background:color-mix(in srgb,var(--xau-warm) 10%,var(--xau-surface-solid))}.xau-platform-head{display:flex;align-items:center;gap:16px}.xau-platform-icon{width:58px;height:58px;display:inline-flex;align-items:center;justify-content:center;flex:0 0 58px;border-radius:14px;border:1px solid var(--xau-border-strong);background:color-mix(in srgb,var(--xau-bg) 72%,var(--xau-surface-solid));box-shadow:0 16px 36px color-mix(in srgb,var(--xau-warm) 12%,transparent);overflow:hidden}.xau-platform-icon img{width:100%;height:100%;display:block;object-fit:contain}.xau-cta{padding:44px;text-align:center;background:linear-gradient(135deg,color-mix(in srgb,var(--xau-warm) 14%,var(--xau-surface-solid)),var(--xau-surface-solid) 58%,color-mix(in srgb,var(--xau-accent) 10%,var(--xau-surface-solid)))}.xau-cta p{max-width:700px;margin:16px auto 0;color:var(--xau-muted);font-size:16px;line-height:1.75}
