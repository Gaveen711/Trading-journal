    ...
    const ctx = gsap.context(() => {
      ...
      mm.add('(min-width: 980px)', () => {
        ...
        cards.forEach((card, index) => {
          if (index === 0) return;
          const startAt = (index - 0.5) / (cards.length - 1);
          const duration = 0.15;
          tl.to(cards[index - 1], { autoAlpha: 0.36, x: -6, scale: 0.98, duration, ease: 'power1.inOut' }, startAt);
          tl.to(card, { autoAlpha: 1, x: 0, scale: 1, duration, ease: 'power1.inOut' }, startAt);
        });
